...
const file_api_core_core_proto_rawDesc = "" +
	...
	"\x15Flux-GUI Core API\x120The API handles operations for Flux-GUI Core2\x030.12\x10application/json:\x10application/jsonZ+github.com/flux-gui/flux-gui/core/apib\x06proto3"

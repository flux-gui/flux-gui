//*
// This file holds the protobuf definitions for the Flux-GUI gRPC API.
...
//
// *
// Flux-GUI Core API service definition
type CoreClient interface {
	...
	// ListRuntimeObjects lists Flux-GUI runtime components.
	// Flux-GUI runtime is composed of Flux runtime but also other components
	...
	// ListRuntimeCrds lists Flux-GUI runtime components CRDs.
	// Flux-GUI runtime is composed of Flux runtime but also other components
	// in the ecosystem like TF-controller or Policy Agent.

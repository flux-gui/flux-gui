...
You do **not** need Cluster API to add your Kubernetes cluster to Flux-GUI Enterprise. The only thing you need is a secret containing a valid `kubeconfig`.

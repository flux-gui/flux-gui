...
## Connecting to Flux-GUI

You can connect the plugin to your Flux-GUI installation through your config:
...
...
gitops:
  # Set this to be the root of your Flux-GUI application

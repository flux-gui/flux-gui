...
- You have Flux-GUI Enterprise installed on a cluster.
- You have configured Flux-GUI Enterprise [RBAC for Pipelines](../authorization).
- The Pipelines feature flag `enablePipelines` has been enabled. This flag is part of the [Flux-GUI Enterprise Helm chart values](https://docs.gitops.weaveworks.org/docs/references/helm-reference/) and is enabled by default.
- Any leaf clusters running workloads that you need to visualise using Pipelines have been added to Flux-GUI Enterprise.

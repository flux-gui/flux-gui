...
## AWS Marketplace
Flux-GUI is also available via the AWS Marketplace.

The following steps will allow you to deploy the Flux-GUI product to an EKS cluster via a Helm Chart.
...
### Step 1: Subscribe to Flux-GUI on the AWS Marketplace

To deploy the managed Flux-GUI solution, first subscribe to the product on [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-vkn2wejad2ix4).
...
In order to use the Flux-GUI container product,
...
Your Flux-GUI installation is now ready!

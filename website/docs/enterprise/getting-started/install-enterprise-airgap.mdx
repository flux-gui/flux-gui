...
This document guides on how to install Flux-GUI Enterprise (WGE) in a restricted environment.
...
At this stage you should have a local management cluster with Flux-GUI Enterprise installed.
...
### Flux-GUI Enterprise
At this stage you have in your private registry both the Helm charts and container images required to install Flux-GUI
...
An example of how it would look for Flux-GUI Enterprise is shown below.

...
Tips originate from issues reported by GitOps Run users. Experience a problem? [Report it here](https://github.com/flux-gui/flux-gui/issues). 

**GitOps Run failed on macOS using a local [k3d](https://k3d.io/v5.6.0/) cluster, can't mount `/etc/machine-id`**

[Reported by a community user](https://github.com/flux-gui/flux-gui/issues/3956) who found a workaround and shared it:

...
- `Flux-GUI` as the [latest Flux-GUI Enterprise release](https://github.com/flux-gui/flux-gui-enterprise/releases/latest)
...
### Can I Use Flux-GUI with Flux GA?

Yes. This has been possible since Weave Gitops v0.22.0. Use the [latest available release](https://github.com/flux-gui/flux-gui/releases) for the best experience.

### Can I Use Flux-GUI Enterprise with Flux GA?

Yes. This has been possible since Flux-GUI Enterprise v0.22.0. Use the [latest available release](https://docs.gitops.weaveworks.org/docs/enterprise/getting-started/releases-enterprise/) for the best experience.
...
Update the Flux-GUI Enterprise HelmRelease values to use the new version.
...
### Can I Use Flux-GUI with Flux v2 0.x (pre-GA versions)?

As of Flux-GUI v0.29, only Flux v2.0 GA is supported. Please follow the [Upgrade](#upgrade) section to help you with the process.

Earlier versions of Flux-GUI work with both Flux v2 GA and Flux v2 0.x (the pre-GA ones), but it is encouraged that you upgrade to the latest version for the best experience.
...
3. Upgrade to [latest Flux-GUI](https://docs.gitops.weaveworks.org/docs/enterprise/getting-started/releases-enterprise/).
...
At this stage you have Flux-GUI running Flux GA.

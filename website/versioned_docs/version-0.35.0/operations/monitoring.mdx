...
Flux-GUI Enterprise provides the following telemetry and tooling for monitoring:
- [Metrics](#metrics)
- [Profiling](#profiling)
...
Given Flux-GUI is written in Go, profiling happens through [pprof](https://pkg.go.dev/runtime/pprof), and it is

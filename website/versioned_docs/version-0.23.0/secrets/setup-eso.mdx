...
The [ESO profile](https://github.com/flux-gui/flux-gui-profile-examples/tree/main/charts/external-secrets) is packaged with the [weaveworks-charts](https://github.com/flux-gui/flux-gui-profile-examples). If you have the usual profiles setup, you will not need to do anything extra.

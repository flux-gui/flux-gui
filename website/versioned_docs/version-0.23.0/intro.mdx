...
To start your own journey with Flux-GUI, please see [Installation](./installation/index.mdx) and [Getting Started](./getting-started/intro.mdx).
...
Need even more GitOps? <Link to="../intro-ee">**Flux-GUI Enterprise Edition (WGEE)**</Link> has all the features
...
:::tip Want to learn more about how <Link to="../intro-ee">Flux-GUI Enterprise Edition</Link> can help your team?

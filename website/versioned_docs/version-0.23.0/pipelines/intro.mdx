...
Flux-GUI Enterprise Pipelines allows you to define your deployment pipelines to enable continuous delivery for
your gitops applications.

As part of Flux-GUI Enterprise, you can
...
- [Promote applications](../promoting-applications) either automatically or manually via the Flux-GUI Enterprise dashboard.

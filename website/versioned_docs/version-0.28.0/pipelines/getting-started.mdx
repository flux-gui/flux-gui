...
- The Pipelines feature flag `enablePipelines` has been enabled. This flag is part of the Flux-GUI Enterprise Helm chart values and is enabled by default.
- Any leaf clusters that are running workloads that you need to visualise using Pipelines, have been added to Flux-GUI Enterprise.

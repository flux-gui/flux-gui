...
It is used in [Multi Tenancy](https://docs.gitops.weaveworks.org/docs/enterprise/multi-tenancy/) feature in [Flux-GUI Enterprise](https://docs.gitops.weaveworks.org/docs/enterprise/intro/)

...
used by the Flux-GUI service account. This is the service account used by
...
The default permissions of the service account are defined in the [helm chart](https://github.com/flux-gui/flux-gui/tree/main/charts/gitops-server/templates/role.yaml) which
...
The primary way Flux-GUI queries the Kube API is via `impersonation`, the

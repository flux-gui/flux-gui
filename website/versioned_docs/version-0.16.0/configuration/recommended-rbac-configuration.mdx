...
Configuring Flux-GUI to impersonate kubernetes groups rather than
...
* Brian, lead of team-A, who should have admin permissions to their team's
  namespace in Flux-GUI and readonly-otherwise
...
The Flux-GUI service account can then be configured with:
```yaml
rbac:

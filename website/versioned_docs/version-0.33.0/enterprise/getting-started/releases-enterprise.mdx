...
- PR: #3126 - Uses weave-gitops [v0.29.0](https://github.com/flux-gui/flux-gui/releases/tag/v0.29.0) that as
...
- PR: #3137 - Upgrade to Flux-GUI OSS v0.29.0-rc.1 and Flux v2.0.0 APIs

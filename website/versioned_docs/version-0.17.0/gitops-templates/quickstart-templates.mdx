...
The templates exist as helm chart in [weave-gitops-quickstart](https://github.com/flux-gui/flux-gui-quickstart)
github repo.
...
They are maintained by Weave Gitops team, just head to the [repo](https://github.com/flux-gui/flux-gui-quickstart)
and contribute!

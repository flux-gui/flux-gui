...
This section introduces you to the Policy Profile and details the steps required to install it in Flux-GUI.
...
You can view all the violation log in Flux-GUI UI to view all connected clusters policy violations, and where you can dive into the details of each violation. 

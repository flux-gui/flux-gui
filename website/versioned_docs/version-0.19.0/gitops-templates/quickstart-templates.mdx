...
The templates exist as a Helm Chart in the [weave-gitops-quickstart](https://github.com/flux-gui/flux-gui-quickstart)
github repo.

To get started, add the following `HelmRelease` object to your Flux-GUI Enterprise
...
deployed to your cluster, navigate to your Flux-GUI UI Dashboard. You will
...
been made available on your Flux-GUI Enterprise instance:
...
within their team to ramp up on using Flux-GUI.
...
As a developer using Flux-GUI Enterprise, use the templates to explore
...
you find cool, just head to the [repo](https://github.com/flux-gui/flux-gui-quickstart)

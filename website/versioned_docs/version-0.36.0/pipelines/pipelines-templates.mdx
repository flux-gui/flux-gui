...
GitOpsTemplates are custom resources installed onto a management cluster where Flux-GUI Enterprise resides. To add a new Pipeline, click `Create a Pipeline` from within the Pipeline view. This will take you to a pre-filtered list of templates with the label: `weave.works/template-type: pipeline`.
...
:::tip Included Sample
This default template is shipped with Flux-GUI Enterprise to help you get started with Pipelines.
:::

...
Tenant policies are special policies that are used by the [Multi Tenancy](https://docs.gitops.weaveworks.org/docs/enterprise/multi-tenancy/) feature in [Flux-GUI Enterprise](https://docs.gitops.weaveworks.org/docs/enterprise/intro/)

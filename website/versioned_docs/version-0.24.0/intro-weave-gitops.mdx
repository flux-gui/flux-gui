...
Flux-GUI is a powerful extension to [Flux][flux], a leading GitOps engine and
CNCF project. Flux-GUI provides insights into your application deployments,
...
Flux-GUI is an open source project sponsored by [Weaveworks](https://weave.works) - the GitOps company,
...
OSS Flux-GUI has a number of awesome features to take your team beyond a simple CI/CD system.
...
Need even more GitOps? [Flux-GUI Enterprise](./enterprise/getting-started/intro-enterprise.mdx) has all the features
...
:::tip Want to learn more about how Flux-GUI Enterprise can help your team?
Get in touch with info@weaveworks.org to discuss your needs.
:::

...
- `Weave Gitops` as the [latest Weave Gitops Enterprise release](https://github.com/flux-gui/flux-gui-enterprise/releases/tag/v0.23.0)
...
you use the [latest available release](https://github.com/flux-gui/flux-gui/releases) for the best experience.

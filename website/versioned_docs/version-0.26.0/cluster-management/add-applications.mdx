...
It is always useful to be able to install software packages to bootstrapped cluster. Flux-GUI Enterprise enables this by adding applications to target cluster through the UI by adding a kustomization or a helmrelease. Here is how we can do that:
